...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname part3chap18worm) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Exercise 264
...
(define (any-hit-wall? ws)
  (ormap hit-wall? (worm-segments ws)))
